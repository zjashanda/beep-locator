---
name: beep-locator
description: Locate fixed-frequency beep markers in PCM/WAV audio and write time-point result files beside the audio. Use when asked to find蜂鸣特征, beep marker positions, fixed 1kHz two-beep sync tones, or to analyze 16000Hz mono 16-bit PCM/WAV recordings for actual beep locations while distinguishing detected audio from sync-inferred windows.
---
